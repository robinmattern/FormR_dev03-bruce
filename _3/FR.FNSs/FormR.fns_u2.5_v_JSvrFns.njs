...
//          FORMRs_4       =    `${ APP_HOME.replace( /[\\/]app[0-9]+[sc][0-9]*/i, '' ) }/_4/FR.fns02s/`    //#.(10317.01.1 RAM Server's Home if dynamically assigned).(10327.02.1 RAM Allow for trailing no: e.g. app08s1).(10901.02.1)
            FORMRs_4       =    `${ APP_HOME.replace( /[\\/]\w+$/,                      '/_4/FR.fns02s/' ) }`    // .(10901.02.1 RAM Remove trailing app name whatever it may be)
                               if ( APP_HOME.match(     /_4[\\\/]FR.app02s/ ) ) {                                            // .(10331.02.1 RAM Will we ever get it right)
