...
##RFILE    +====================+=======+===================+======+=============+
##FD    JSvrFns_u2.4.njs        |  30841|  5/29/21  1:15:00p|   384| v2.4.10529
##DESC     .--------------------+-------+-------------------+------+------------+
...
#
##CHGS     .--------------------+-------+-------------------+------+-----------+
# .(01012.01 10/12/12 RAM       | Wrote setAppDirs)
# .(10218.04  2/18/18 RAM       | Wrote chkRegEx)
# .(10224.02  2/24/14 RAM       | Above no working because it running in Master folder)
# .(10228.11  2/28/18 RAM       | Add global utility fns)
##.(10301.01  3/01/11 RAM       | Set project name for parsing function call stack)
# .(10301.11  3/01/11 RAM       | __dirname is not in v10.12+)
# .(10301.14  3/01/11 RAM       | Moving it here requires a different path)
# .(10303.02  3/03/13 RAM       | Moved to JScript.njs)
# .(10303.03  3/03/13 RAM       | Set bQuiet to true if false )
# .(10305.02  3/05/15 RAM       | Gotta get server or client folder name)
# .(10315.04  3/15/15 RAM       | Do it here, Save it in process, not process.env, which is a string)
# .(10316.12  3/16/16 RAM       | Set APP_HOME here)
# .(10317.03  3/17/17 RAM       | Peel back to before /api or /src)
##.(10317.04  3/17/17 RAM       | Don't know why this is there sometimes)
# .(10318.02  3/18/18 RAM       | Jeese Louise, what is the names of the app)
# .(10319.07  3/19/19 RAM       | Get it here is exists)
# .(10323,02  3/23/13 RAM       | He uses the same middleware name for each method. S.B. different for each)
# .(10326.04  3/26/16 RAM       | Ad nWdt arg)
# .(10327.02  3/27/17 RAM       | Allow for trailing no: e.g. app08s1)
# .(10328.04  3/28/18 RAM       | Why _4)
# .(10328.05  3/28/18 RAM       | Jeese Louise cubed!)
# .(10331.02  3/31/11 RAM       | Will we ever get it right)
# .(10402.03  4/02/12 RAM       | Added tests ??)
# .(10402.04  4/02/12 RAM       | Write for FormR.fns)
# .(10403.03  4/03/13 RAM       | Gotta have both)
# .(10403.05  4/03/13 RAM       | I think APP_4s = APP_HOME in this case)
# .(10405.01  4/05/15 RAM       | Added shoModel)
# .(10405.02  4/05/15 RAM       | Maybe here is good)
# .(10407.01  4/07/17 RAM       | Do db_logging( pDB, 'on|off' ))
# .(10415.03  4/15/15 RAM       | Add Uppercase)
# .(10418.01  4/18/18 RAM       | Pass just a Sequilize Model)
# .(10512.06  5/12/12 RAM       | Put into .ENV)
# .(10518.02  5/18/18 RAM       | This is much better)
# .(10518.03  5/18/18 RAM       | Added).(10529.04.3 RAM New Version name)
# .(10518.04  5/18/18 RAM       | Added setAppVarss1 and 2)
# .(10518.05  5/18/18 RAM       | Added client)
# .(10518.07  5/18/18 RAM       | Added shoAppVars)
# .(10518.08  5/18/18 RAM       | Jeese Louise to the 5th!)
# .(10528.01  5/28/18 RAM         It's gotta exist)

##PRGM     +====================+===============================================+
##ID 69.600. Main               |
##SRCE     +====================+===============================================+
*/
       var  aJScripts       = '_3/NJSs/JScripts_u2.4.njs'                                                   // .(10518.03.1 RAM Beg Added).(10529.04.3 RAM New Version name)
